    ...
    <div className={styles.container}>
      ...
      <div className={styles.leftPanel}>
        ...
        <div style={{ position: 'absolute', top: '2rem', left: '2.5rem', zIndex: 20, display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          <span style={{ color: '#fff', fontWeight: 'bold', fontSize: '1.25rem', letterSpacing: '0.05em' }}>ChambexCity</span>
        </div>
      ...
      <div className={styles.rightPanel}>
        <div className={styles.formContainer}>
          ...
          <div className={styles.footerText}>
            <p>¿Aún no eres parte de ChambexCity?</p>
            <Link href="/register" className={styles.registerLink}>Crea una cuenta</Link>
          </div>
        </div>

        <p className={styles.copyright}>© 2025 ChambexCity Profesional</p>
      </div>
    </div>
  );
}
