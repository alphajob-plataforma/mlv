        ...
        <div className={styles.topSection}>
          ...
          <div className={styles.brandCol}>
            <div className={styles.brandGroup}>
              {/* Logo ChambexCity */}
              <svg width="28" height="28" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ color: 'var(--brand-mint)' }}>
            ...
            <p className={styles.tagline}>© 2026 ChambexCity. Proyectando el futuro del trabajo digital.</p>
          </div>
